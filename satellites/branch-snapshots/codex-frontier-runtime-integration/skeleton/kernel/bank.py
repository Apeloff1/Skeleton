...
from skeleton.kernel.ops.extras import Extras
...
_MAKERS = {
    ...
    "wave": lambda ov: __import__("skeleton.kernel.ops.wave", fromlist=["Wave"]).Wave(),
}
...
def boot(profile: str = "", overlay: Dict[str, Any] | None = None) -> Dict[str, Any]:
    ...
    if name == "tight":
        ...
        chosen = [
            ...
            "check", "stock", "block", "stock_live", "orch", "extras", "obscure", "socialk", "looped", "wave", "hold", "sfence", "storm",
        ]
