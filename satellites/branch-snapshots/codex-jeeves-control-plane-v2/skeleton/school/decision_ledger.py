...
class EvidenceKind(str,Enum): OBSERVATION="observation"; ASSESSMENT="assessment"; MEMORY="memory"; KNOWLEDGE="knowledge"; REFLECTION="reflection"; TOOL="tool"; MODEL="model"; SYSTEM="system"
class DecisionDisposition(str,Enum): PROPOSED="proposed"; ACCEPTED="accepted"; DEFERRED="deferred"; REJECTED="rejected"; SUPERSEDED="superseded"
...
@dataclass(frozen=True)
class LedgerCheckpoint: sequence:int; head_hash:str; record_count:int
@dataclass
