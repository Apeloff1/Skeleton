"""Configuration tree for Skeleton — settings + snapshot bridge."""
...
def _model_config_env(prefix: str) -> dict:
...
# snapshot bridge (Settings -> kernel ConfigStore)
from skeleton.config.snapshots import (  # noqa: E402
    SettingsBridgeError,
