...
from skeleton.testing.api_gateway_reliability_profiles import (
    run_api_gateway_throughput_profile,
)
...
@pytest.mark.parametrize(
    ...
    [
        (0, 1, "requests must be at least 1"),
        (1, 0, "concurrency must be at least 1"),
    ],
)
