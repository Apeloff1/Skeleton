...
class Genesis:
    ...
    def _phase_support(self) -> None:
        """Wire the support fabric + hardware-specialized OverseerEngine.

        Handles: support, loader, agentic_rag, overseer, engine.
        The engine binds governor budgets onto loader, queue, miner,
        and RAG so every consumer fits this device's hardware envelope.
        """
