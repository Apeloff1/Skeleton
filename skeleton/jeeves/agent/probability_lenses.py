...
class ProbabilityLens(str, Enum):
    """Explicit inference lenses used by Jeeves.

    This is an engineering taxonomy, not a claim that probability theory has a
    universally agreed finite list of interpretations. New values are additive
    so older serialized assessments remain stable.
    """
