...
Every mouth of the organism fights the same closed world:
  ...
  neo      stacked Pre-LN       (hivemind, n_layers=2)
...
def tournament(neo, *, texts=None) -> Dict[str, Any]:
    """Three mouths, one corpus. Winner is min finite perplexity."""
    ...
    return {
        ...
        "succession": {
            ...
            "neo": "hivemind stacked Pre-LN n_layers=2",
            "rule": "acquire copies the MODEL; surpass answers from neo; hive pull inherits the house",
        },
    }
