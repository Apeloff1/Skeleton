...
the full query × candidate product in one native call. They do not require AVX, AVX2,
...
and a non-executable stack linker flag. Runtime loading verifies ABI version 3
