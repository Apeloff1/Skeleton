"""Policy-bound shell execution and orchestration primitives.

The package exposes a bounded argv-only execution boundary together with the
small, deterministic orchestration layer that admits, schedules, executes,
observes, and explains shell work.
"""
...
__all__ = [
    ...
    "DedupeRegistry", "DrainReport", "EnvironmentPolicy", "EnvironmentRejected", "EnvironmentValueRule",
    "ExecutableRegistry", "ExecutableSpec", "ExecutionMetadata", "ExecutionOutcome", "ExecutionReceipt",
    "ExecutorConfig", "FailureClassification", "FailureKind", "HealthFinding", "HistoryQuery", "HookRegistry",
    "JsonlAuditSink", "Lease", "LeaseConflict", "LeaseRegistry", "MANIFEST_SCHEMA_VERSION", "ManifestError",
    "ManifestLimits", "MemoryAuditSink", "NullAuditSink", "OptionRule", "OutputView", "PipelineError",
    "PipelineExecutor", "PipelineResult", "PipelineSpec", "PipelineStep", "PipelineStepResult", "PolicyChange",
    "PolicyDiff", "PolicyProfile", "PolicyProfileCatalog", "PreflightAnalyzer", "PreflightItem", "PreflightReport",
    "QueueItem", "QueueState", "QueueWorker", "RateLimitDecision", "RateLimitPolicy", "RateLimiter", "ReceiptChain",
    "ReceiptHistory", "RedactingAuditSink", "RedactionPolicy", "RedactionRule", "RegistrySnapshot", "ResourceBudget",
    "ResourceLimits", "ResourceUsage", "RetryDecision", "RetryPolicy", "SecretRedactor", "SerializationError",
    "SessionBudgetExhausted", "SessionSnapshot", "ShellCapability", "ShellCommand", "ShellControlPlane",
    "ShellErrorCode", "ShellErrorContext", "ShellExecutionError", "ShellExecutor", "ShellHealthReport",
    "ShellPlaneError", "ShellPlaneStatus", "ShellPolicy", "ShellPolicyError", "ShellResult", "ShellRunner",
    "ShellSession", "ShellTelemetry", "ShellToolAdapter", "ShellWorkQueue", "StepState", "TemplateCatalog",
    "TemplateSlot", "TokenBucket", "ToolExecutionRequest", "ToolExecutionResponse", "ValueConstraint",
    "WorkerCounters", "WorkerGroup", "WorkerGroupSnapshot", "WorkerPolicy", "WorkerSnapshot", "WorkerState",
    "WorkDisposition", "WorkResult", "WorkspacePolicy", "WorkspaceRejected", "build_default_profiles",
    "canonical_json", "classify_result", "combined_summary", "command_fingerprint", "diff_policies",
    "digest_arguments", "digest_environment_keys", "digest_mapping", "digest_path", "dumps", "explain_command",
    "inspect_policy", "intersect_policies", "is_narrower_or_equal", "loads_object", "manifest_dict",
    "narrow_policy", "parse_manifest", "pipeline_from_commands", "policy_fingerprint", "receipt_from_dict",
    "render_output", "sha256_hex", "status_snapshot",
]
