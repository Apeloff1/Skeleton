...
class ServerState:
    ...
    def bind_engine_execution_service(self) -> Any:
        ...
        repository = SQLiteExecutionRepository(settings.execution_state_path)
        submissions = SQLiteEngineSubmissionStore(settings.submission_state_path)
        ...
        service = EngineExecutionService(repository, submissions, authorities)
        receipt_store = SQLiteToolReceiptStore(settings.tool_receipt_path)
