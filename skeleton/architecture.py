...
PACKAGES: Dict[str, Dict[str, Any]] = {
    ...
    "skeleton.application": {"description": "Shared command contracts", "exports": [
        ...
        "CAPABILITY_MANIFEST_VERSION", "CONTRACT_VERSION", "API_ROUTE_AUDIT_KIND", "EXPORT_AUDIT_KIND",
        "GENESIS_BOOT_AUDIT_KIND", "HMAC_OPEN_AUDIT_KIND", "PLANE_AUDIT_KIND", "Capability", "CapabilityLoadError",
        ...
        "get_api_route_audit_row", "get_capability", "get_export_audit_row", "get_genesis_boot_audit_row",
        "get_hmac_open_audit_row", "get_plane_audit_row", "hmac_open_audit_snapshot",
        "load_capability", "parity_matrix", "plane_audit_snapshot",
    ]},
