...
PACKAGES: Dict[str, Dict[str, Any]] = {
    ...
    "skeleton.application": {"description": "Shared command contracts", "exports": [
        ...
        "CAPABILITY_MANIFEST_VERSION", "CONTRACT_VERSION", "API_ROUTE_AUDIT_KIND", "CORTEX_ROUTE_AUDIT_KIND",
        "DEVELOPER_CLI_AUDIT_KIND", "EXPORT_AUDIT_KIND", "GATE_DOMAIN_AUDIT_KIND", "GENESIS_BOOT_AUDIT_KIND",
        "HMAC_OPEN_AUDIT_KIND", "MAIN_CLI_AUDIT_KIND", "MOUNTED_ROUTE_AUDIT_KIND", "PLANE_AUDIT_KIND",
        ...
        "command_specs", "cortex_route_audit_snapshot", "developer_cli_audit_snapshot", "export_audit_snapshot",
        "gate_domain_audit_snapshot", "genesis_boot_audit_snapshot", "get_api_route_audit_row", "get_capability",
        "get_cortex_route_audit_row", "get_developer_cli_audit_row", "get_export_audit_row",
        "get_gate_domain_audit_row", "get_genesis_boot_audit_row", "get_hmac_open_audit_row",
        "get_main_cli_audit_row", "get_mounted_route_audit_row", "get_plane_audit_row",
        "get_sidecar_route_audit_row", "get_template_audit_row", "hmac_open_audit_snapshot",
        "load_capability", "main_cli_audit_snapshot", "mounted_route_audit_snapshot", "parity_matrix",
        "plane_audit_snapshot", "sidecar_route_audit_snapshot", "template_audit_snapshot",
    ]},
