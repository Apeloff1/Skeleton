...
PACKAGES: Dict[str, Dict[str, Any]] = {
    ...
    "skeleton.application": {"description": "Shared command contracts", "exports": [
        "ADMIT_WRITE_AUDIT_KIND", "API_ROUTE_AUDIT_KIND", "APP_ROUTE_AUDIT_KIND", "AUDITED_PLANE_IDS", "CAPABILITIES",
        "CAPABILITIES_BY_ID", "CAPABILITY_LOADER", "CAPABILITY_MANIFEST_VERSION", "CAPABILITY_VIEW_AUDIT_KIND",
        "CHARTER_AUDIT_KIND", "CLI_SHARED_AUDIT_KIND", "CONTRACT_AUDIT_KIND", "CONTRACT_VERSION",
        "CORTEX_ROUTE_AUDIT_KIND", "DEVELOPER_CLI_AUDIT_KIND",
        ...
        "NESTED_ROUTER_AUDIT_KIND", "PLANE_AUDIT_KIND", "SEAL_AUDIT_KIND", "SIDECAR_ROUTE_AUDIT_KIND",
        "TEMPLATE_AUDIT_KIND",
        ...
        "charter_audit_snapshot", "cli_shared_audit_snapshot", "command_specs",
        ...
        "genesis_boot_audit_snapshot", "get_admit_write_audit_row", "get_api_route_audit_row",
        "get_app_route_audit_row",
        "get_capability", "get_capability_view_audit_row", "get_charter_audit_row",
        "get_cli_shared_audit_row", "get_contract_audit_row",
        "get_cortex_route_audit_row",
        "get_developer_cli_audit_row", "get_env_flag_audit_row", "get_export_audit_row",
        "get_gate_domain_audit_row", "get_gate_limit_audit_row", "get_genesis_boot_audit_row",
        ...
        "get_nested_router_audit_row", "get_plane_audit_row", "get_seal_audit_row",
        "get_sidecar_route_audit_row",
        "get_template_audit_row", "hmac_open_audit_snapshot", "idempotency_audit_snapshot",
