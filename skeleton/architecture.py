...
PACKAGES: Dict[str, Dict[str, Any]] = {
    ...
    "skeleton.application": {"description": "Shared command contracts", "exports": [
        ...
        "TEMPLATE_AUDIT_KIND", "VERSION_AUDIT_KIND",
        ...
        "get_template_audit_row", "get_version_audit_row", "hmac_open_audit_snapshot",
        ...
        "seal_audit_snapshot",
        "sidecar_route_audit_snapshot", "template_audit_snapshot", "version_audit_snapshot",
    ]},
