...
PACKAGES: Dict[str, Dict[str, Any]] = {
    ...
    "skeleton.application": {"description": "Shared command contracts", "exports": [
        ...
        "CAPABILITY_MANIFEST_VERSION", "CONTRACT_VERSION", "EXPORT_AUDIT_KIND",
        "GENESIS_BOOT_AUDIT_KIND", "PLANE_AUDIT_KIND", "Capability", "CapabilityLoadError",
        "CapabilityLoader", "CapabilityRuntimeStatus", "CommandError", "CommandResult",
        "CommandService", "CommandSpec", "build_runtime_command_service",
        "capability_lifecycle_snapshot", "capability_manifest", "capability_runtime_status",
        "command_specs", "export_audit_snapshot", "genesis_boot_audit_snapshot",
        "get_capability", "get_export_audit_row", "get_genesis_boot_audit_row",
        "get_plane_audit_row", "load_capability", "parity_matrix", "plane_audit_snapshot",
    ]},
...
API_ROUTES: List[Dict[str, Any]] = [
    ...
    {"method": "POST", "path": "/api/v1/gameforge/intake", "protected": False, "description": "GameForge intake questionnaire"},
    {"method": "POST", "path": "/api/v1/swarm/submit", "protected": False, "description": "Submit swarm task"},
