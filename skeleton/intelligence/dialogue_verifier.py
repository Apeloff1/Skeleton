...
class DialogueVerifier:
    ...
    def verify(self, tree: Mapping[str, Any], *, description: str = "") -> DialogueVerificationReport:
        ...
        return DialogueVerificationReport(accepted=accepted, score=score, reason=reason, weakest_path=weakest, thresholds={"dialogue_accept_at": self.accept_at}, summary=summary, issues=tuple(issues), quality=quality)
