...
_DELTA: Dict[str, Dict[str, Any]] = {
    ...
    "metroidvania": {
        ...
        "meta": {"philosophy": "ability_gated_backtrack", "permadeath": 0.10, "authorial": 0.45},
    },
    "roguelike": {
        "player": {"speed": 180.0, "sprint_multiplier": 1.40},
        "ttk": {"trash": 0.8, "elite": 3.5, "boss": 40.0, "player_glass": 0.9},
        "session": {"collapse_max": 1800.0},
        "meta": {"philosophy": "run_knowledge", "permadeath": 1.0, "authorial": 0.35},
    },
    "jrpg": {
        ...
        "meta": {"philosophy": "party_attrition", "permadeath": 0.05, "authorial": 0.70},
    },
    "crpg": {
        "player": {"speed": 140.0, "sprint_multiplier": 1.20},
        "ttk": {"trash": 3.0, "elite": 10.0, "boss": 150.0, "player_glass": 5.0},
        "session": {"collapse_max": 2400.0},
        "meta": {"philosophy": "build_expression", "permadeath": 0.20, "authorial": 0.65},
    },
    "immersive_sim": {
        ...
        "meta": {"philosophy": "systemic_emergence", "permadeath": 0.25, "authorial": 0.60},
    },
    "stealth": {
        ...
        "session": {"collapse_max": 600.0},
        "meta": {"philosophy": "unseen_agency", "permadeath": 0.40, "authorial": 0.40},
    },
    "tactics_grid": {
        "player": {"speed": 100.0, "sprint_multiplier": 1.0, "i_frame_ms": 0.0},
        "ttk": {"trash": 2.0, "elite": 6.0, "boss": 90.0, "player_glass": 3.0},
        "session": {"collapse_max": 1800.0},
        "meta": {"philosophy": "positional_certainty", "permadeath": 0.30, "authorial": 0.50},
    },
    "fighting_game": {
    ...
    "battle_royale": {
        ...
        "session": {"collapse_max": 1200.0},
        "meta": {"philosophy": "shrinking_agency", "permadeath": 1.0, "authorial": 0.15},
    },
    "mmorpg": {
        ...
        "meta": {"philosophy": "raid_as_social_machine", "permadeath": 0.05, "authorial": 0.20},
    },
    "visual_novel": {
        ...
        "session": {"collapse_max": 9999.0},
        "meta": {"philosophy": "choice_as_combat", "permadeath": 0.0, "authorial": 0.85},
    },
    "walking_sim": {
        ...
        "session": {"collapse_max": 9999.0},
        "meta": {"philosophy": "presence", "permadeath": 0.0, "authorial": 0.80},
    },
    "grand_strategy": {
        ...
        "meta": {"philosophy": "systems_as_history", "permadeath": 0.40, "authorial": 0.55},
    },
    "city_builder": {
        "player": {"speed": 100.0, "sprint_multiplier": 1.0},
        "ttk": {"trash": 15.0, "elite": 40.0, "boss": 200.0, "player_glass": 30.0},
        "session": {"collapse_max": 99999.0},
        "meta": {"philosophy": "growth_under_constraint", "permadeath": 0.10, "authorial": 0.40},
    },
}
