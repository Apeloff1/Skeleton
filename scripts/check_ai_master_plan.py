...
def validate(data: dict) -> list[str]:
    ...
    if PLAN.is_file():
        ...
        for marker in ("## 21. P0 build program", "## 21.5 Systems-engineering closure overlay", "## 21.6 Adversarial cross-condition closure overlay", "## 21.7 Atomic task engineering propagation", "## 22. Vertical-slice acceptance ladder", "## 24.2 Volume maturity promotion contract", "## 24.3 Volume depth passes", "## 25. Scope freeze"):
