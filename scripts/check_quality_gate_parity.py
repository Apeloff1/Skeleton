...
SHARED_BACKEND_MARKERS: tuple[tuple[str, str], ...] = (
    ...
    ("defense control-plane contract", "check_defense_control_plane_contract.py"),
    ("scanner integrity fail-closed regression", "test_scanner_integrity.py"),
    ("defense contract fail-closed regression", "test_defense_control_plane_contract.py"),
    ...
    ("rooted filesystem boundary regression", "test_security_rooted_fs.py"),
    ("archive sandbox regression", "test_security_archive_sandbox.py"),
    ("peer-bound outbound HTTP regression", "test_security_outbound_http.py"),
    ...
    ("dependency-security workflow contract", "test_dependency_security_workflow_contract.py"),
