...
- [ ] `ACC-AIQ-S0-STATE-03` — AIQ-S0-STATE-03 Prove authoritative restore first and derived index/cache rebuild second. — status: `evidence_pending` — builder: **chatgpt:gpt-5.6-sol** — verifier: **UNSIGNED** — completed_at_utc: `—`
