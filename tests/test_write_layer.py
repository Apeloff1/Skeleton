...
class WriteLayerGenerationTests(unittest.TestCase):
    def test_multi_pass_writer_builds_and_repairs_in_memory(self) -> None:
        ...
        with (
            ...
            patch(
                "skeleton.automation.write_layer.repository_machine_context",
                return_value="machine topology context",
            ),
            patch(
        ...
        self.assertIn("machine topology context", client.calls[0][1])
        self.assertEqual(
