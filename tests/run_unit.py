...
TEST_MODULE_NAMES = (
    ...
    "skeleton.testing.test_simulation_physics_capsule_mesh",
    ...
    "skeleton.testing.test_simulation_physics_convex_ccd",
    "skeleton.testing.test_simulation_physics_convex_hull_distance",
    ...
    "skeleton.testing.test_simulation_physics_mesh",
