...
export const LEGACY_CAPABILITIES: readonly LegacyCapability[] = [
  ...
  },
  {
    ...
    state: 'evolving',
    risk: 'medium',
    replacement: 'Versioned source ledger with provenance',
    notes: 'Manual provenance records are live; automated RSS/feed adapters remain queued behind the same ledger contract.',
  },
  {
  ...
  },
  {
    ...
    state: 'absorbed',
    risk: 'low',
    replacement: 'Versioned Work OS session ledger',
    notes: 'Clock transitions persist locally through a versioned ledger with legacy migration.',
  },
  {
    id: 'clock-breaks',
    source: 'Clock-in/out app',
    ...
    notes: 'Pause states are gated behind active work, persisted as ledger entries, and excluded from productive coin accrual.',
  },
  {
  ...
  },
  {
    ...
    notes: 'Productive time now drives the 200-coins/hour mechanic; configurability and broader wealth integration continue evolving.',
  },
  {
    id: 'shared-bookmarks',
