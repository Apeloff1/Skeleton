...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    // Keep server polling out of the critical cold-start window. Device
    // connectivity is already observed by StabilityBanner immediately; the
    // tunnel heartbeat can safely begin once the first screen has painted.
