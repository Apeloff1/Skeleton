    ...
    if verification:
        ...
        invariants += [
            ...
            AssuranceInvariant("truth.evidence-default-citation-bound", "hard", registry.get("truth_eligible_default") is True,
                               f"truth_eligible_default={registry.get('truth_eligible_default', False)}"),
            ...
            AssuranceInvariant("truth.calibration-nonauthoritative", "hard", calibration.get("truth_authority") is False,
                               f"truth_authority={calibration.get('truth_authority', True)}"),
