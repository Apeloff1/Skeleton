...
@pytest.mark.parametrize(
    ("kwargs", "message"),
    [
        ({"per_minute": 0}, r"per_minute must be (?:finite and )?positive"),
        ({"burst": 0}, r"burst must be (?:finite and )?positive"),
        ({"max_buckets": 0}, r"max_buckets must be (?:a )?positive(?: integer)?"),
